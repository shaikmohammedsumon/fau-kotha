...
<head>
    ...
    <!-- waves.css -->
    <link rel="stylesheet" href="{{asset('asset/dashboard')}}/pages/waves/css/waves.min.css" type="text/css" media="all">
      <!-- Required Fremwork -->
      ...
      <!-- Font Awesome -->
      <link rel="stylesheet" type="text/css" href="{{asset('asset/dashboard')}}/icon/font-awesome/css/font-awesome.min.css">
      <!-- scrollbar.css -->
  ...
  <div id="pcoded" class="pcoded">
          ...
          <nav class="navbar header-navbar pcoded-header">
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      ...
                      <a href="index.html">
                          <img class="img-fluid" src="{{asset('asset/dashboard')}}/images/logo.png" alt="Theme-Logo" />
                      </a>
                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                          <li class="header-notification">
                              ...
                              <ul class="show-notification">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="{{asset('asset/dashboard')}}/images/avatar-2.jpg" alt="Generic placeholder image">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="{{asset('asset/dashboard')}}/images/avatar-4.jpg" alt="Generic placeholder image">
                                          <div class="media-body">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="{{asset('asset/dashboard')}}/images/avatar-3.jpg" alt="Generic placeholder image">
                                          <div class="media-body">
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  <img src="{{asset('asset/dashboard')}}/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                  <span>John Doe</span>
                              ...
                              <ul class="show-notification profile-notification">
                                  ...
                                  <li class="waves-effect waves-light">
                                    <form action="{{route('logout')}}" method="POST">
                                        ...
                                        <button type="submit" style="border: none; background:none; outline: none; cursor: pointer;">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                  <img class="img-80 img-radius" src="{{asset('asset/dashboard')}}/images/avatar-4.jpg" alt="User-Profile-Image">
                              ...
                              <div class="main-menu-content">
                                  <ul>
                                      <li class="more-details">
                                          ...
                                          <form action="{{route('logout')}}" method="POST">
                                            @csrf
                                            <button type="submit"  style="border: none; background:none; margin-left:20px; outline: none; cursor: pointer;">
            ...
            <ul class="iew-download">
                <li>
                    <a href="http://www.google.com/chrome/">
                        <img src="{{asset('asset/dashboard')}}/images/browser/chrome.png" alt="Chrome">
                        <div>Chrome</div>
                    </a>
                </li>
                <li>
                    <a href="https://www.mozilla.org/en-US/firefox/new/">
                        <img src="{{asset('asset/dashboard')}}/images/browser/firefox.png" alt="Firefox">
                        <div>Firefox</div>
                    </a>
                </li>
                <li>
                    <a href="http://www.opera.com">
                        <img src="{{asset('asset/dashboard')}}/images/browser/opera.png" alt="Opera">
                        <div>Opera</div>
                    </a>
                </li>
                <li>
                    <a href="https://www.apple.com/safari/">
                        <img src="{{asset('asset/dashboard')}}/images/browser/safari.png" alt="Safari">
                        <div>Safari</div>
                    </a>
                </li>
                <li>
                    <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                        <img src="{{asset('asset/dashboard')}}/images/browser/ie.png" alt="">
                        <div>IE (9 & above)</div>
                    </a>
                </li>
            </ul>
    ...
    <script type="text/javascript" src="{{asset('asset/dashboard')}}/js/jquery-slimscroll/jquery.slimscroll.js "></script>
    <!-- modernizr js -->
